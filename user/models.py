...
class UserManager(BaseUserManager):
    ...
    def _create_user(self,email,full_name,company, password, **extra_fields):
        """
    ...
    def create_user(self, email,full_name,company,password=None, **extra_fields):
        ...
        return self._create_user(email,full_name,company,password, **extra_fields)

    def create_superuser(self, email,full_name,company, password=None, **extra_fields):
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    company=models.CharField(_('company'),max_length=50,blank=False)
...
class project_files(models.Model):
    ...
    def __str__(self):
        return str(self.client.full_name)
